        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo "/assets/images/twitter-logo.png"; ?>" alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo  "/includes/icons/tweethome.png"; ?>" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img
                src="<?php echo "./include/icons/tweetnotif.png"; ?>"
                alt=""
                height="26.25px"
                width="26.25px"
              />
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
              <img src="<?php echo"/includes/icons/tweetprof.png"; ?>" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="<?php echo "/includes/icons/tweetsetting.png"; ?>" alt="" height="26.25px" width="26.25px" />
            </div>
